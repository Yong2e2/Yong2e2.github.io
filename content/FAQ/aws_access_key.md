...
생성된 Access key와 Secret access key로 [진단대상 추가](../../진단대상 관리\_진단요청/진단대상 추가/)에서 등록후 D-CLO 서비스를 이용하시면 됩니다.
...
생성된 역할의 ARN과 역할의 이름으로 [진단 설정/진단 대상] 페이지의 [진단대상 추가](../../진단대상 관리\_진단요청/진단대상 추가/)에서 등록 후 D-Clo 서비스를 이용하시면 됩니다.
